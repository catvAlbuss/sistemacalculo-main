...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("colRect").addEventListener("change", function () {
    toggleShapes("rectangle", this.checked);
  });

  document.getElementById("colCuad").addEventListener("change", function () {
    toggleShapes("cuadrado", this.checked);
  });

  document.getElementById("colCircle").addEventListener("change", function () {
    toggleShapes("circulo", this.checked);
  });

  document.getElementById("colT").addEventListener("change", function () {
    toggleShapes("te", this.checked);
  });

  document.getElementById("colL").addEventListener("change", function () {
    toggleShapes("ele", this.checked);
  });

  document.getElementById("vigaPrin").addEventListener("change", function () {
    toggleShapes("cuadradovigas", this.checked);
  });

  document.getElementById("vigaCimen").addEventListener("change", function () {
    toggleShapes("cuadradovigascimentacion", this.checked);
  });

  document.getElementById("losaCuad").addEventListener("change", function () {
    toggleShapes("cuadradolosas", this.checked);
  });

  document.getElementById("zapataCuad").addEventListener("change", function () {
...
document.getElementById("btn_pdf_predim").addEventListener("click", () => {
