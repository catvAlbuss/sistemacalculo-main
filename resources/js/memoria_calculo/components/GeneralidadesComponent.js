...
export function createGeneralidadesComponent() {
  return {
    ...
    get isComplete() {
      ...
      const generalidadesValid = validateGeneralidades(this.$store.memoriaCalculo.sections.generalidades).valid;
...
>>>>>>> 214c24bba7f9f12cdbf217e63261464dbacb13ec
    ...
    validate() {
      ...
      const generalidadesValidation = validateGeneralidades(this.$store.memoriaCalculo.sections.generalidades);

      const allErrors = [...coverValidation.errors, ...generalidadesValidation.errors];
