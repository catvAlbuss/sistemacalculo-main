    ...
    <div class="container mx-auto flex flex-row flex-wrap items-start space-x-2 py-2 md:flex-nowrap"
        ...
        <x-input-data>
            <div class="mb-4 w-full">
                <x-input-select-calc name="Grupo" bind="calcs.grupo" unit="Kg/cm2"
                    :options='$grupos'></x-input-select-calc>
        ...
        <x-output-data>
            <x-table-result title="1.- Prerequisitos del Diseño">
                ...
                <x-output-calc name="Esfuerzo admisible al corte parealela" symbol="Fv" bind="calcs.diseñoFv"
                    unit="Kg/cm2"></x-output-calc>
                <x-output-calc name="Longitud efectiva" symbol="lef" bind="calcs.diseñoLef"
                    unit="m"></x-output-calc>
