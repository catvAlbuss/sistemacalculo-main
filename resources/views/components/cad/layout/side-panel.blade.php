<!-- Side Panel -->
<aside class="cad-bg cad-border relative flex h-full w-20 shrink-0 flex-col border-r-4"
    x-data="{ itemsPanelCollapsed: true }">
    {{-- ============================================================
    ...
    <button @click="itemsPanelCollapsed = !itemsPanelCollapsed" title="Mostrar / ocultar panel de Items y Propiedades"
    ...
    <div class="flex flex-1 flex-col overflow-y-auto">
        ...
        {{-- Dibujar --}}
        <div
            class="border-b border-gray-700/70 bg-gray-900/30 py-1 text-center text-[9px] font-semibold uppercase tracking-wide text-gray-400">
            Dibujar</div>

        <div class="flex flex-col gap-1">
            <button
                title="Columnas: clic en un vértice de grilla para una sola, o arrastra un rectángulo para varias (solo en planta)"
                ...
                class="{{ $qt }}">
                <span class="text-base leading-none"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        viewBox="0 0 24 24">
            ...
            <button title="Dibujar frame / barra (funciona en 2D y 3D)" @click="cadSystem.activateDrawFrameTool()"
            ...
            <button
                title="Vigas por región: clic cerca de un lado de grilla para una sola, o arrastra un rectángulo para varias (planta o elevación)"
            ...
            <button title="Losa rectangular: 2 clics (esquinas opuestas)"
                ...
                <span class="text-base leading-none"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        ...
                        <rect fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" width="16" height="16" x="4" y="4" rx="1" />
                    </svg></span><span>Losa Rect.</span>
            </button>
            <button
                title="Muro: clic sobre una viga o un lado de grilla = muro completo en 1 clic. O 2 clics en vértices/nodos para un largo custom (solo desde un piso, no la Base)"
                ...
                :class="currentState === wallSegmentDrawingState
                    ...
                    : (cadSystem.isBasePlanViewActive?.() ? 'text-gray-500 opacity-40 cursor-not-allowed' : 'text-gray-200')" class="{{ $qt }}">
                <span class="text-base leading-none"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        viewBox="0 0 24 24">
                        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2">
            ...
            <button
                title="Ortho (F8): al dibujar Zapata a mano alzada, fuerza cada lado nuevo a salir horizontal o vertical respecto al anterior, para hacerla simétrica."
                @click="cadSystem.options.orthoMode = !cadSystem.options.orthoMode"
                :class="cadSystem.options.orthoMode ? 'bg-blue-600 text-white' : 'text-gray-200'" class="{{ $qt }}">
                <span class="text-base leading-none">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" viewBox="0 0 24 24">
                        <path d="M4 4v16h16" />
        ...
        {{-- soportes --}}
        <div
            class="border-y border-gray-700/70 bg-gray-900/30 py-1 text-center text-[9px] font-semibold uppercase tracking-wide text-gray-400">
            Apoyos</div>
        <div class="flex flex-col gap-1">
            ...
            <button title="Asignar soportes / restraints a los nodos seleccionados"
                @click="cadSystem.activateAssignMenuAction('joint-restraints')" class="{{ $qt }} text-gray-200">
        ...
        <div class="flex flex-col gap-1">
            <button title="Carga distribuida en vigas / frames seleccionados"
                @click="cadSystem.activateAssignMenuAction('frame-load-distributed')" class="{{ $qt }} text-gray-200">
                <span class="text-base leading-none"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" d="m7 6l5 5l5-5M7 13l5 5l5-5" />
                    </svg></span><span>Viga</span>
            </button>
            <button title="Carga puntual (fuerza) en nodos seleccionados"
                @click="cadSystem.activateAssignMenuAction('joint-load-force')" class="{{ $qt }} text-gray-200">
                <span class="text-base leading-none"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="2" />
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"
                            d="M22 12h-4M6 12H2m10-6V2m0 20v-4" />
                    </svg></span><span>Nodo</span>
            </button>
            <button title="Carga uniforme de área en losas seleccionadas"
                @click="cadSystem.activateAssignMenuAction('area-load-uniform')" class="{{ $qt }} text-gray-200">
                <span class="text-base leading-none"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        viewBox="0 0 24 24">
                        <rect width="18" height="18" x="3" y="3" rx="2" fill="none" stroke="currentColor"
                            stroke-width="2" />
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" d="M12 8v8m-4-4l4 4l4-4" />
                    </svg></span><span>Losa</span>
            </button>
        </div>
        ...
        <div class="flex flex-col gap-1">
            <button title="Asignar sección de frame a los frames seleccionados"
                @click="cadSystem.activateAssignMenuAction('frame-section')" class="{{ $qt }} text-gray-200">
                <span class="text-base leading-none"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        viewBox="0 0 24 24">
                        <rect width="20" height="12" x="2" y="6" fill="none" stroke="currentColor"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2" rx="2" />
                    </svg></span><span>Frame Sec.</span>
            </button>
            <button title="Asignar sección de losa a las losas seleccionadas"
                @click="cadSystem.activateAssignMenuAction('area-slab-section')" class="{{ $qt }} text-gray-200">
                <span class="text-base leading-none"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        viewBox="0 0 24 24">
                        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2">
                            <path
                                d="M4 10c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h4c1.1 0 2 .9 2 2m0 12c-1.1 0-2-.9-2-2v-4c0-1.1.9-2 2-2h4c1.1 0 2 .9 2 2" />
    ...
    <div x-show="!itemsPanelCollapsed" x-cloak x-transition
        class="cad-bg cad-border absolute left-full top-0 z-20 flex h-full w-80 flex-col overflow-y-auto rounded-r-md border-r-4 shadow-2xl">
        ...
        <x-cad.ui.panel title="Propiedades" init="isOpen = true">
                ...
                <div x-show="moveObjectState.selectedObject">
                    <div class="flex flex-col gap-2 p-2">
                        <template x-if="moveObjectState.selectedObject">
                            <x-cad.ui.input-properties label="ID" bind="moveObjectState.selectedObject.id"
                        ...
                        <x-cad.ui.panel-properties title="Posición">
                            ...
                            <!-- NUEVO: Campo Z -->
                            <template x-if="moveObjectState.selectedObject">
                                <x-cad.ui.input-properties label="Z" bind="moveObjectState.selectedObject.position.z"
                                    handleInput=""></x-cad.ui.input-properties>
                            </template>
                        ...
                        <x-cad.ui.panel-properties title="Soporte">
                            <div class="flex flex-row justify-between">
                                <x-cad.ui.ribbon-button
                                    ...
                                    toggle="moveObjectState.selectedObject?.soporte === ''" label=""
                                ...
                                <x-cad.ui.ribbon-button
                                    ...
                                    toggle="moveObjectState.selectedObject?.soporte === 'soporteUno'" label=""
                                    class="cad-ribbon-button-hover-bg transition-colors duration-200 p-2 rounded">
                                    <div class="flex flex-col items-center">
                                ...
                                <x-cad.ui.ribbon-button
                                    ...
                                    toggle="moveObjectState.selectedObject?.soporte === 'soporteDos'" label=""
                                    class="cad-ribbon-button-hover-bg transition-colors duration-200 p-2 rounded">
                                    <div class="flex flex-col items-center">
                                ...
                                <x-cad.ui.ribbon-button
                                    ...
                                    toggle="moveObjectState.selectedObject?.soporte === 'soporteTres'" label=""
                                    class="cad-ribbon-button-hover-bg transition-colors duration-200 p-2 rounded">
                                    <div class="flex flex-col items-center">
            ...
            <template x-if="currentState === selectedNodesState">
                <div class="flex flex-col gap-2 p-2"
                    x-data="{ fx: undefined, fy: undefined, fz: undefined, selected: null }">
                    <x-cad.ui.panel-properties title="Fuerza">
                        <x-cad.ui.input-properties label="Fx" bind="fx" handleInput="currentState.selectedObjects.forEach((n) => {
                                      n.force.x = fx;
                                  })"></x-cad.ui.input-properties>
                        <x-cad.ui.input-properties label="Fy" bind="fy" handleInput="currentState.selectedObjects.forEach((n) => {
                                  n.force.y = fy;
                              })"></x-cad.ui.input-properties>
                        <!-- NUEVO: Fz -->
                        <x-cad.ui.input-properties label="Fz" bind="fz" handleInput="currentState.selectedObjects.forEach((n) => { 
                                  n.force.z = fz;
                              })"></x-cad.ui.input-properties>
                    ...
                    <x-cad.ui.panel-properties title="Soporte">
                        <div class="row flex">
                            <x-cad.ui.ribbon-button clickHandler="cadSystem.clearJointSupportAssignments(
        Array.from(currentState.selectedObjects || [])
    ); selected = ''" toggle="selected === ''" label="">
                                <x-cad.svg.sinsoporte></x-cad.svg.sinsoporte>
                            </x-cad.ui.ribbon-button>
                            <x-cad.ui.ribbon-button clickHandler="currentState.selectedObjects.forEach((n) => {
                                      n.soporte = 'soporteUno';
                                  });selected = 'soporteUno'" toggle="selected === 'soporteUno'"
                                label=""><x-cad.svg.soporte1></x-cad.svg.soporte1></x-cad.ui.ribbon-button>
                            <x-cad.ui.ribbon-button clickHandler="currentState.selectedObjects.forEach((n) => {
                                      n.soporte = 'soporteDos';
                                  });selected = 'soporteDos'" toggle="selected === 'soporteDos'"
                                label=""><x-cad.svg.soporte2></x-cad.svg.soporte2></x-cad.ui.ribbon-button>
                            <x-cad.ui.ribbon-button clickHandler="currentState.selectedObjects.forEach((n) => {
                                      n.soporte = 'soporteTres';
                                  });selected = 'soporteTres'" toggle="selected === 'soporteTres'"
            ...
            <template x-if="currentState === selectedBeamsState && selectedBeamsState.selectedObjects.length > 1">
                ...
                A: undefined
                    ...
                    <x-cad.ui.panel-properties title="Material">
                        <x-cad.ui.input-properties label="Modulo Elástico" bind="E" handleInput="currentState.selectedObjects.forEach((b) => {
                          b.E = E;
                      })"></x-cad.ui.input-properties>
                        <x-cad.ui.seccion-select bind="A" handleInput="currentState.selectedObjects.forEach((b) => {
                        b.A = A;
            ...
            <template x-if="currentState === selectedBeamsState && selectedBeamsState.selectedObjects.length === 1">
                <div class="p-2">
                    ...
                    <x-cad.ui.panel-properties title="Material">
                        <x-cad.ui.input-properties label="Modulo Elástico"
                            bind="selectedBeamsState.selectedObjects[0].E" handleInput=""></x-cad.ui.input-properties>
                        <x-cad.ui.seccion-select bind="selectedBeamsState.selectedObjects[0].A"
                            handleInput=""></x-cad.ui.seccion-select>
                        <x-cad.ui.input-properties label="Área de la sección"
                            bind="selectedBeamsState.selectedObjects[0].A" handleInput=""
                            disabled="true"></x-cad.ui.input-properties>
                    </x-cad.ui.panel-properties>
                </div>
            </template>
            <template
                ...
                <div class="p-2">
                    <x-cad.ui.panel-properties title="Parametros">
                        ...
                        <x-cad.ui.input-properties label="Flecha"
                            bind="selectedParametricState.selectedObjects[0].flecha"
                            handleInput="selectedParametricState.selectedObjects[0].build(); _ajustarModeloElevacion(selectedParametricState.selectedObjects[0])"></x-cad.ui.input-properties>
                        <x-cad.ui.input-properties label="Dovela"
                            bind="selectedParametricState.selectedObjects[0].dovela"
                            handleInput="selectedParametricState.selectedObjects[0].build(); _ajustarModeloElevacion(selectedParametricState.selectedObjects[0])"
                            minimun="0.001" step="0.1"></x-cad.ui.input-properties>
                ...
                <div class="p-2">
                    <x-cad.ui.panel-properties title="Parametros">
                        <x-cad.ui.input-properties label="Alto" bind="selectedParametricState.selectedObjects[0].width"
                            handleInput="selectedParametricState.selectedObjects[0].build(); _ajustarModeloElevacion(selectedParametricState.selectedObjects[0])"></x-cad.ui.input-properties>
                        <x-cad.ui.input-properties label="Anchó"
                            bind="selectedParametricState.selectedObjects[0].height"
                            handleInput="selectedParametricState.selectedObjects[0].build(); _ajustarModeloElevacion(selectedParametricState.selectedObjects[0])"></x-cad.ui.input-properties>
                        <x-cad.ui.input-properties label="Peralte"
                            bind="selectedParametricState.selectedObjects[0].peralte"
                            handleInput="selectedParametricState.selectedObjects[0].build(); _ajustarModeloElevacion(selectedParametricState.selectedObjects[0])"></x-cad.ui.input-properties>
                        <x-cad.ui.input-properties label="Dovela"
                            bind="selectedParametricState.selectedObjects[0].dovela"
            ...
            <template
                ...
                <div class="p-2">
                    <x-cad.ui.panel-properties title="Parametros">
                        <x-cad.ui.input-properties label="Altura"
                            bind="selectedParametricState.selectedObjects[0].altura"
                            handleInput="selectedParametricState.selectedObjects[0].build(); _ajustarModeloElevacion(selectedParametricState.selectedObjects[0])"></x-cad.ui.input-properties>
            ...
            <template x-if="currentState === editParametricState && currentState.editing">
                <div class="p-2">
                    <x-cad.ui.panel-properties title="Material">
                        <x-cad.ui.input-properties label="Modulo Elástico" bind="currentState.editing[0].E" handleInput="currentState.editing.forEach((b) => {
