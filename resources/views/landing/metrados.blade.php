  ...
  <div class="mx-auto max-w-7xl p-6 lg:p-8">
    ...
    <div class="grid grid-cols-[1fr] gap-4 md:grid-cols-3">
      ...
      <div
        ...
        <h3 class="py-5 text-center text-2xl font-bold">Elaboración de Metrados Estructurales</h3>
        <p class="py-2 text-center">Optimiza tus costos con nuestros metrados estructurales detallados y exactos.
