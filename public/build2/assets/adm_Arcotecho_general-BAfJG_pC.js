$(document).ready(function(){$("#desingButton").click(V=>{V.preventDefault();const f=parseFloat(document.getElementById("longitudtransversal").value),H=parseFloat(document.getElementById("alturacolumna").value),s=parseFloat(document.getElementById("luz").value),t=parseFloat(document.getElementById("flecha").value),A=parseFloat(document.getElementById("pesopropio").value),E=parseFloat(document.getElementById("luminarias").value),I=parseFloat(document.getElementById("cargaviva").value),X=parseFloat(document.getElementById("cargaviento").value),Q=parseFloat(document.getElementById("Z").value),U=parseFloat(document.getElementById("U").value),Z=parseFloat(document.getElementById("S").value),N=parseFloat(document.getElementById("C").value),j=parseFloat(document.getElementById("R").value),S=parseFloat(document.getElementById("Ps").value),e=(t*t+s/2*s/2)/(2*t),d=Math.atan(s/2/(e-t)),q=d*(180/Math.PI),a=2*d*e,z=e-e*Math.sin(d)/d,J=a*f,L=e*Math.sin(d/2)/(d/2),p=L*Math.sin(d/2);document.getElementById("datosgeometricos").innerHTML=`
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4'>-</td>
            <td class='py-2 px-4 text-center'>${q.toFixed(2)}°</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'>Angulo de arco</td>
            <td class='py-2 px-4'>θ</td>
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4'>-</td>
            <td class='py-2 px-4 text-center'>${J.toFixed(2)}m<sup>2</sup></td>
        </tr>
        </tr>
          <tr class="bg-gray-100 dark:bg-gray-600">
        ...
        </tr>  `;const h=(A+E)*a,c=h*.5,o=((A+E)*a/2*p-c*s/2)/t,K=(c*c+o*o)**.5,M=I*a,r=M*.5,n=(I*a/2*p-r*s/2)/t,O=(r*r+n*n)**.5;document.getElementById("calculocargas").innerHTML=`
        <tr class="bg-gray-100 dark:bg-gray-600">
        ...
        `;const W=c+.25*r,D=W*2,R=Q*U*Z*N/j,T=D*R,l=T/2,i=l*(t-z)/(s*.5),Y=(l*l+i*i)**.5;document.getElementById("coeficientesismico").innerHTML=`
        <tr class="bg-gray-100 dark:bg-gray-600">
    ...
    `;const at=t/s,F=S,st=S*.8,G=F*a,g=G*.5,B=(F*a/2*p-g*s/2)/t,dt=(g*g+B*B)**.5;document.getElementById("carganieve").innerHTML=`
        <tr class="bg-gray-100 dark:bg-gray-600">
