...
Route::get('blogs_list', [BlogController::class, 'ListarBlogs'])->name('blogs_list');
Route::get('/blogs/{blog}/editarbloginter', [BlogController::class, 'editarbloginter'])->name('blogs.editarbloginter');
Route::post('/blogs/{blog}/updateblogdetaill', [BlogController::class, 'updateblogdetaill'])->name('blogs.updateblogdetaill'); */
