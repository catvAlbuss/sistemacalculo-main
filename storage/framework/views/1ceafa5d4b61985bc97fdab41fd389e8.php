...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.calc-layout','data' => ['title' => 'Diseño Muros de albañilería']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Diseño Muros de albañilería']); ?>
    <div class="py-12">
                ...
                <div class="w-full md:w-1/3">
                    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                        ...
                        <div class="overflow-auto">
                            <form action="<?php echo e(route('malbaCont')); ?>" method="POST" id="datamurosAlb">
                                <?php echo csrf_field(); ?>
    ...
    <?php if (! $__env->hasRenderedOnce('de941e21-be56-4b7a-8413-856840253adf')): $__env->markAsRenderedOnce('de941e21-be56-4b7a-8413-856840253adf');
$__env->startPush('scripts'); ?>
        <?php echo app('Illuminate\Foundation\Vite')('resources/js/adm_muros_albanieria.js'); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\hcalculo\admMurosAlbanieria.blade.php ENDPATH**/ ?>