...
<section id="section-info-general" x-data="createGeneralidadesComponent()"
    ...
    <div class="py-4 border-t border-gray-200 dark:border-gray-700 mt-6">
        <?php echo $__env->make('hcalculo.memoria_calculo.partials.cover-images', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</section><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\memoria_calculo\sections\informacion-general.blade.php ENDPATH**/ ?>