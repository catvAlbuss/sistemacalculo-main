...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.calc-layout','data' => ['title' => 'Cimiento Corrido']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Cimiento Corrido']); ?>
  <div class="py-12">
        ...
        <div class="w-full md:w-1/3">
          <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
            ...
            <div class="overflow-auto">
              <form id="cimientosControler" method="POST" action="<?php echo e(route('cimientocorrido')); ?>">
                <?php echo csrf_field(); ?>
  ...
  <?php if (! $__env->hasRenderedOnce('135be518-510e-4e87-9f7d-b201e9b3768c')): $__env->markAsRenderedOnce('135be518-510e-4e87-9f7d-b201e9b3768c');
$__env->startPush('scripts'); ?>
  <script src="https://cdn.jsdelivr.net/npm/echarts@latest/dist/echarts.min.js"></script>
  <?php echo app('Illuminate\Foundation\Vite')('resources/js/adm_cimiento_corrido.js'); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\admCimientoCorrido.blade.php ENDPATH**/ ?>