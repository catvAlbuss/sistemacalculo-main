<div x-id="['dropdownNavbarLink', 'dropdownNavbar']">
  <button id="$id(dropdownNavbarLink)" data-dropdown-toggle="$id(dropdownNavbar)" aria-current="<?php echo e($aria_current()); ?>"
    <?php echo e($attributes->merge(['class' => $get_class() . ' flex w-full items-center justify-between px-3 py-2 md:w-auto md:border-0 md:p-0'])); ?>><?php echo e($name); ?><svg
...
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views/components/nav-link-sub-landing.blade.php ENDPATH**/ ?>