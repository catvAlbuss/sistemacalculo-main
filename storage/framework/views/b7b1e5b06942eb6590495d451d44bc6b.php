...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.calc-layout','data' => ['title' => 'Diseño de Cerco Perimetrico']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Diseño de Cerco Perimetrico']); ?>
  <div class="py-12">
              ...
              <table class="min-w-full text-gray-800 dark:text-white" id="desingcorte">
                ...
                <tbody class="bg-gray-100 py-2 dark:bg-gray-800">
                  ...
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='px-4 py-2'colspan="4" rowspan="8"><img
                        src="<?php echo e(Vite::asset('resources/img/calc/map.png')); ?>" alt="Viga"></td>
                  </tr>
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    <td class='px-8 py-2'></td>
                ...
                <tbody class="bg-gray-100 py-2 dark:bg-gray-800">
                  ...
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='px-4 py-2' rowspan="5" colspan="4">
                      <img src="<?php echo e(Vite::asset('resources/img/calc/viga.png')); ?>" alt="Viga">
                    </td>
                    </td>
                  </tr>
                  <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <tbody class="bg-gray-100 py-2 dark:bg-gray-800">
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='px-4 py-2' colspan="7"><img
                        src="<?php echo e(Vite::asset('resources/img/calc/columna.png')); ?>" alt="Viga"></td>
                  </tr>
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    <td class='px-8 py-2'>Carga sísmica para peso propio del muro</td>
                    <td class='px-4 py-2'>wppalb</td>
                ...
                <tbody class="bg-gray-100 py-2 dark:bg-gray-800">
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='px-4 py-2' colspan="7"> <img
                        src="<?php echo e(Vite::asset('resources/img/calc/momentos.png')); ?>" alt="momentum"></td>
                  </tr>
                  <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <tbody class="bg-gray-100 py-2 dark:bg-gray-800">
                  ...
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    <td class='px-4 py-2' colspan="8"><img src="<?php echo e(Vite::asset('resources/img/calc/hc.png')); ?>"
                  ...
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    <td class='px-4 py-2 text-center' colspan="8"> <img
                        src="<?php echo e(Vite::asset('resources/img/calc/d2.png')); ?>" alt="d2"
                ...
                <tbody class="bg-gray-100 py-2 dark:bg-gray-800">
                  ...
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    <td class='px-8 py-2' colspan="8"><img
                        src="<?php echo e(Vite::asset('resources/img/calc/ra1.png')); ?>" alt="Viga" /></td>
                  </tr>
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    <td class='px-8 py-2'></td>
                    <td class='px-4 py-2'></td>
                ...
                <tbody class="bg-gray-100 py-2 dark:bg-gray-800">
                  ...
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    <td class='px-8 py-2' colspan="8"><img
                        src="<?php echo e(Vite::asset('resources/img/calc/ra2.png')); ?>" alt="Viga" /></td>
                  </tr>
                  <tr class="bg-gray-100 dark:bg-gray-600">
                    <td class='px-8 py-2'></td>
                    <td class='px-4 py-2'></td>
    ...
    <?php if (! $__env->hasRenderedOnce('eb6cfeaa-f9f7-4962-ba46-648e176a7888')): $__env->markAsRenderedOnce('eb6cfeaa-f9f7-4962-ba46-648e176a7888');
$__env->startPush('scripts'); ?>
      <script src="https://cdnjs.cloudflare.com/ajax/libs/paper.js/0.12.15/paper-full.min.js"></script>
      <?php echo app('Illuminate\Foundation\Vite')('resources/js/cercoPerimetrico/cercoPerimetricoCalc.js'); ?>
      <?php echo app('Illuminate\Foundation\Vite')('resources/js/cercoPerimetrico/drawCP.js'); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\hcalculo\adm_CercoPerimetrico.blade.php ENDPATH**/ ?>