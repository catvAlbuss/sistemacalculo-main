...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo e(url('/assets/img/logo_rizabalAsociados.png')); ?>">
    <!-- Fonts -->
        ...
        <div class="container mx-auto flex flex-wrap items-center justify-between">
            <div class="flex items-center justify-center space-x-2">
                ...
                <a href="https://ryaie.com/" class="text-white text-lg font-bold py-2">
                    <img class="mx-auto h-10 w-10 logo" src="<?php echo e(url('/assets/img/logo_rizabalAsociados.png')); ?>" alt="author avatar">
                </a>
            ...
            <div class="hidden md:block w-full md:w-auto" id="mobile-menu">
                <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                    ...
                    <li>
                        <a href="<?php echo e(url('admcontactenos')); ?>" class="text-gray-950 dark:text-gray-100  dark:hover:text-white border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Contactenos</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('blogs.index')); ?>" class="text-gray-950 dark:text-gray-100 hover:text-gray-700 dark:hover:text-white py-2">
                            Blog
                        </a>
                    </li>
                    <li>
                    ...
                    <li
                        ...
                        <div class="order-1 sm:ml-6 xl:ml-0 p-4">
                            <h3 class="mb-2 text-slate-900 dark:text-white font-semibold text-xl">
                                <span
                                    class="block text-indigo-500 dark:text-indigo-400 mb-2 text-sm"><?php echo e($blog->titulo); ?></span>
                            </h3>
                            <div class="prose prose-slate prose-sm text-slate-500 dark:text-slate-400 mb-4">
                                <p><?php echo e($blog->descripcion); ?></p>
                            </div>
                            <div class="grid grid-cols-2 gap-4 text-sm text-slate-700 dark:text-slate-300">
                                <div class="text-gray-950 dark:text-white">
                                    <p><?php echo e($blog->ubicacion); ?></p>
                                </div>
                                <div class="text-gray-950 dark:text-white">
                                    <p><?php echo e(\Carbon\Carbon::parse($blog->fecha_publicacion)->timezone('America/Lima')->format('d \d\e F \d\e Y')); ?>
                            ...
                            <?php if($blog): ?>
                                <a href="<?php echo e(route('blogs.show', $blog)); ?>"
                                    ...
                                    Ver más
                                    <span class="sr-only">, <?php echo e($blog->titulo); ?></span>
                        ...
                        <img src="<?php echo e(url('/assets/img/blog/' . $blog->imagenref)); ?>" alt="<?php echo e($blog->titulo); ?> "
...
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\blogs\index.blade.php ENDPATH**/ ?>