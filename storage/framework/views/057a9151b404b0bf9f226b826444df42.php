                ...
                <div class="overflow-x-auto">
                    <table id="" class="min-w-full text-gray-800 dark:text-white">
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800 py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    <th class='py-2 px-4' rowspan='5'>Pisos <?php echo e($piso_num + 1); ?></th>
                                    <?php
                                    ...
                                    <th>1.40CM+1.70CV</th>
                                    <th><?php echo e($P); ?></th>
                                    <th><?php echo e($vux); ?></th>
                                    <th><?php echo e($v1y); ?></th>
                                    <th><?php echo e($topmx1); ?></th>
                                    <th><?php echo e($buttonmx1); ?></th>
                                    <th><?php echo e($topmy1); ?></th>
                                    <th><?php echo e($buttonmy1); ?></th>
                                    <th><?php echo e($Py); ?></th>
                                    <th><?php echo e($vux1); ?></th>
                                    <th><?php echo e($vyY); ?></th>
                                    <th><?php echo e($topmx2); ?></th>
                                    <th><?php echo e($buttonmyx2); ?></th>
                                    <th><?php echo e($topmyy2); ?></th>
                                    <th><?php echo e($buttonmyy); ?></th>
                                </tr>

                                <?php for($subfila = 2; $subfila <= 5; $subfila++): ?>
                                    <tr class="bg-gray-100 dark:bg-gray-600">
                                        <?php switch($subfila):
                                            case (2): ?>
                                                <th class='py-2 px-4'>1.25(CM+CV)+CS</th>
                                                <td class='py-2 px-4'><?php echo e($Pc); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vucx); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vcsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmxcs); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmxcs); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmycs); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmycs); ?></td>

                                                <td class='py-2 px-4'><?php echo e($Pcsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vucsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vycs); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmxycs); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmyxcs); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmyycss); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmyycs); ?></td>
                                            <?php break; ?>

                                            <?php case (3): ?>
                                                <th class='py-2 px-4'>1.25(CM+CV)-CS</th>
                                                <td class='py-2 px-4'><?php echo e($Pcn); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vucnx); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vcnsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmxcns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmxcns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmycns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmycns); ?></td>

                                                <td class='py-2 px-4'><?php echo e($Pcnsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vucnsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vycns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmxycns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmyxcns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmyycns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmyycns); ?></td>
                                            <?php break; ?>

                                            <?php case (4): ?>
                                                <th class='py-2 px-4'>0.90CM+CS</th>
                                                <td class='py-2 px-4'><?php echo e($Pms); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vums); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vyms); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmxms); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmxms); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmyms); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmyms); ?></td>

                                                <td class='py-2 px-4'><?php echo e($Pmsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vuxms); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vmsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmsmx); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmsmy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmsmyy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmsmyy); ?></td>
                                            <?php break; ?>

                                            <?php case (5): ?>
                                                <th class='py-2 px-4'>0.90CM-CS</th>
                                                <td class='py-2 px-4'><?php echo e($Pmns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vumns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vymns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmxmns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmxmns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmymns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmymns); ?></td>

                                                <td class='py-2 px-4'><?php echo e($Pmnsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vuxmns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($vmnsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmsmnx); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmsmny); ?></td>
                                                <td class='py-2 px-4'><?php echo e($topmsmnyy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($buttonmsmnyy); ?></td>
                                            <?php break; ?>
                                        <?php endswitch; ?>
                                    </tr>
                                <?php endfor; ?>
                ...
                <div class="overflow-x-auto">
                    <table id="" class="min-w-full text-gray-800 dark:text-white">
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            ...
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr>
                                    <th rowspan="5">Piso <?php echo e($piso_num + 1); ?></th>
                                    <td>Pu máx</td>
                                    <?php
                                    ...
                                    ?>
                                    <td><?php echo e($valor_piso_actual); ?></td>
                                    <td>Ton</td>
                                </tr>
                                <?php for($subfila = 2; $subfila <= 5; $subfila++): ?>
                                    <tr class="bg-gray-100 dark:bg-gray-600">
                                        <?php switch($subfila):
                                            case (2): ?>
                                                ...
                                                <td class='py-2 px-4'><?php echo e($mulMax); ?></td>
                                                <td class='py-2 px-4'>Ton.m</td>
                                            <?php break; ?>

                                            <?php case (3): ?>
                                                <th class='py-2 px-4'>Mu2 máx</th>
                                                <td class='py-2 px-4'><?php echo e($mu2Max); ?></td>
                                                <td class='py-2 px-4'>Ton.m</td>
                                            <?php break; ?>
                                        <?php endswitch; ?>
                                    </tr>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            ...
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr>
                                    ...
                                    ?>
                                    <td><?php echo e($valor_piso_actualyy); ?></td>
                                    <td>Ton</td>
                                </tr>
                                <?php for($subfila = 2; $subfila <= 5; $subfila++): ?>
                                    <tr class="bg-gray-100 dark:bg-gray-600">
                                        <?php switch($subfila):
                                            case (2): ?>
                                                <th class='py-2 px-4'>Mu1 máx</th>
                                                <td class='py-2 px-4'><?php echo e($muylMax); ?></td>
                                                <td class='py-2 px-4'>Ton.m</td>
                                            <?php break; ?>

                                            <?php case (3): ?>
                                                <th class='py-2 px-4'>Mu2 máx</th>
                                                <td class='py-2 px-4'><?php echo e($muy2Max); ?></td>
                                                <td class='py-2 px-4'>Ton.m</td>
                                            <?php break; ?>
                                        <?php endswitch; ?>
                                    </tr>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800 py-2">
                            ...
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    <td class='py-2 px-4'><?php echo e($indiceQX[$piso_num]); ?></td>
                                    <td class='py-2 px-4'><?php echo e($tipoEstructuraX[$piso_num]); ?></td>
                                    <td class='py-2 px-4'><?php echo e($RREX); ?></td>
                                    <td class='py-2 px-4'><?php echo e($CDEZ); ?></td>
                                    <td class='py-2 px-4'><?php echo e($H); ?></td>
                                    <td class='py-2 px-4'><?php echo e($klu); ?></td>
                                    <td class='py-2 px-4'><?php echo e($verfi); ?></td>
                                    <?php for($subfila = 2; $subfila <= 5; $subfila++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    <?php switch($subfila):
                                        case (2): ?>
                                            <td class='py-2 px-4'>Dirección Y-Y</td>
                                            <td class='py-2 px-4'><?php echo e($indiceQY[$piso_num]); ?></td>
                                            <td class='py-2 px-4'><?php echo e($tipoEstructuraY[$piso_num]); ?></td>
                                            <td class='py-2 px-4'><?php echo e($RREX); ?></td>
                                            <td class='py-2 px-4'><?php echo e($CDEZ); ?></td>
                                            <td class='py-2 px-4'><?php echo e($H); ?></td>
                                            <td class='py-2 px-4'><?php echo e($kluy); ?></td>
                                            <td class='py-2 px-4'><?php echo e($verfiy); ?></td>
                                        <?php break; ?>
                                    <?php endswitch; ?>
                                </tr>
                            <?php endfor; ?>
                ...
                <div class="overflow-x-auto">
                    <table id="" class="min-w-full text-gray-800 dark:text-white">
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800 py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    <th class='py-2 px-4' rowspan="5">Piso <?php echo e($piso_num + 1); ?></th>
                                    <?php
                                        $valor_piso_actual = isset($valorpm[$piso_num]) ? $valorpm[$piso_num] : ''; // Obtener el valor o cadena vacía si no está definido
                                        $valor_piso_actualyy = isset($valorpmyy[$piso_num])
                                            ? $valorpmyy[$piso_num]
                                    ...
                                    <td class='py-2 px-4'><?php echo e($m1ton); ?></td>
                                    <td class='py-2 px-4'><?php echo e($m2ton); ?></td>
                                    <td class='py-2 px-4'><?php echo e($m1m2); ?></td>
                                    <td class='py-2 px-4'><?php echo e($tipflexion); ?></td>
                                    <td class='py-2 px-4'><?php echo e($calmm); ?></td>
                                    <td class='py-2 px-4'><?php echo e($veresbeltez); ?></td>
                                    <td class='py-2 px-4'><?php echo e($bd); ?></td>
                                    <td class='py-2 px-4'><?php echo e($elton); ?></td>
                                    <td class='py-2 px-4'><?php echo e($pcton); ?></td>
                                    <td class='py-2 px-4'><?php echo e($m2min); ?></td>
                                    <td class='py-2 px-4'><?php echo e($cm); ?></td>
                                    <td class='py-2 px-4'><?php echo e($ns); ?></td>
                                    <td class='py-2 px-4'><?php echo e($mcTon); ?></td>
                                </tr>
                                <?php for($subfila = 2; $subfila <= 5; $subfila++): ?>
                                    <tr class="bg-gray-100 dark:bg-gray-600">
                                        <?php switch($subfila):
                                            case (2): ?>
                                                <td class='py-2 px-4'>Dirección Y-Y</td>
                                                <td class='py-2 px-4'><?php echo e($m1tony); ?></td>
                                                <td class='py-2 px-4'><?php echo e($m2tony); ?></td>
                                                <td class='py-2 px-4'><?php echo e($m1m2y); ?></td>
                                                <td class='py-2 px-4'><?php echo e($tipflexiony); ?></td>
                                                <td class='py-2 px-4'><?php echo e($calmmy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($veresbeltezy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($bdy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($eltony); ?></td>
                                                <td class='py-2 px-4'><?php echo e($pctony); ?></td>
                                                <td class='py-2 px-4'><?php echo e($m2miny); ?></td>
                                                <td class='py-2 px-4'><?php echo e($cmy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($nsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($mcTony); ?></td>
                                            <?php break; ?>
                                        <?php endswitch; ?>
                                    </tr>
                                <?php endfor; ?>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800 py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    ?>
                                    <td class='py-2 px-4'>Dirección X-X</td>
                                    <td class='py-2 px-4'><?php echo e($kluart); ?></td>
                                    <td class='py-2 px-4'><?php echo e($verez); ?></td>
                                    <td class='py-2 px-4'><?php echo e($os1); ?></td>
                                    <td class='py-2 px-4'><?php echo e($LArx[$piso_num]); ?></td>
                                    <td class='py-2 px-4'><?php echo e($pcmmedlx); ?></td>
                                    <td class='py-2 px-4'><?php echo e($Epcx); ?></td>
                                    <td class='py-2 px-4'><?php echo e($os2x); ?></td>
                                    <td class='py-2 px-4'><?php echo e($osx); ?></td>
                                    <td class='py-2 px-4'><?php echo e($lurx); ?></td>
                                    <td class='py-2 px-4'><?php echo e($raizpux); ?></td>
                                    <td class='py-2 px-4'><?php echo e($verificacionArticuloX); ?></td>
                                    <td class='py-2 px-4'><?php echo e($m1tonx); ?></td>
                                    <td class='py-2 px-4'><?php echo e($m2tonx); ?></td>
                                    <td class='py-2 px-4'><?php echo e($Cmverfx); ?></td>
                                    <td class='py-2 px-4'><?php echo e($OnsCDx); ?></td>
                                </tr>
                                <?php for($subfila = 2; $subfila <= 5; $subfila++): ?>
                                    <tr class="bg-gray-100 dark:bg-gray-600">
                                        <?php switch($subfila):
                                            case (2): ?>
                                                <td class='py-2 px-4'>Dirección Y-Y</td>
                                                <td class='py-2 px-4'><?php echo e($kluarty); ?></td>
                                                <td class='py-2 px-4'><?php echo e($verezy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($os1y); ?></td>
                                                <td class='py-2 px-4'><?php echo e($LAry[$piso_num]); ?></td>
                                                <td class='py-2 px-4'><?php echo e($pcmmedly); ?></td>
                                                <td class='py-2 px-4'><?php echo e($Epcy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($os2y); ?></td>
                                                <td class='py-2 px-4'><?php echo e($ossy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($lury); ?></td>
                                                <td class='py-2 px-4'><?php echo e($raizpuy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($verificacionArticuloY); ?></td>
                                                <td class='py-2 px-4'><?php echo e($m1tony); ?></td>
                                                <td class='py-2 px-4'><?php echo e($m2tony); ?></td>
                                                <td class='py-2 px-4'><?php echo e($Cmverfxy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($OnsCDy); ?></td>
                                            <?php break; ?>
                                        <?php endswitch; ?>
                                    </tr>
                                <?php endfor; ?>
                ...
                <div class="overflow-x-auto">
                    <table id="" class="min-w-full text-gray-800 dark:text-white">
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    <th>Piso <?php echo e($piso_num + 1); ?></th>
                                    <?php
                                        $IFy = 0.7;
                                        $AgL = $L1 * $L2;
                                        $Pon = round(
                                    ...
                                    ?>
                                    <td><?php echo e($hx[$piso_num]); ?></td>
                                    <td><?php echo e($AAceroTotal); ?></td>
                                    <td><?php echo e($AgL); ?></td>
                                    <td><?php echo e($Pon); ?></td>
                                    <td><?php echo e($PnMax); ?></td>
                                    <td><?php echo e($pnx); ?></td>
                                    <td><?php echo e($pny); ?></td>
                                    <td><?php echo e($PonFy); ?></td>
                                    <td><?php echo e($Pn); ?></td>
                                    <td><?php echo e($pnFy); ?></td>
                                    <td><?php echo e($VerifiArt); ?></td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    <td class='py-2 px-4'><?php echo e($Py); ?></td>
                                    <td class='py-2 px-4'><?php echo e($rx); ?></td>
                                    <td class='py-2 px-4'><?php echo e($ry); ?></td>
                                    <td class='py-2 px-4'><?php echo e($verartxx); ?></td>
                                    <td class='py-2 px-4'><?php echo e($verartyy); ?></td>
                                </tr>
                                <?php for($subfila = 2; $subfila <= 5; $subfila++): ?>
                                    <tr class="bg-gray-100 dark:bg-gray-600">
                                        <?php switch($subfila):
                                            case (2): ?>
                                                ...
                                                <td class='py-2 px-4'><?php echo e($Pc); ?></td>
                                                <td class='py-2 px-4'><?php echo e($Pcsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($rPc); ?></td>
                                                <td class='py-2 px-4'><?php echo e($rPcsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($verartxxpc); ?></td>
                                                <td class='py-2 px-4'><?php echo e($verartcsy); ?></td>
                                            <?php break; ?>
                                            ...
                                            <?php case (3): ?>
                                                ...
                                                <td class='py-2 px-4'><?php echo e($Pcn); ?></td>
                                                <td class='py-2 px-4'><?php echo e($Pcnsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($rPcn); ?></td>
                                                <td class='py-2 px-4'><?php echo e($rPcnsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($verpcn); ?></td>
                                                <td class='py-2 px-4'><?php echo e($verartpsy); ?></td>
                                            <?php break; ?>
                                            ...
                                            <?php case (4): ?>
                                                ...
                                                <td class='py-2 px-4'><?php echo e($Pms); ?></td>
                                                <td class='py-2 px-4'><?php echo e($Pmsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($rPms); ?></td>
                                                <td class='py-2 px-4'><?php echo e($rPmsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($verpms); ?></td>
                                                <td class='py-2 px-4'><?php echo e($verartpmy); ?></td>
                                            <?php break; ?>
                                            ...
                                            <?php case (5): ?>
                                                ...
                                                <td class='py-2 px-4'><?php echo e($Pmns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($Pmnsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($rPmns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($rPmnsy); ?></td>
                                                <td class='py-2 px-4'><?php echo e($verpmns); ?></td>
                                                <td class='py-2 px-4'><?php echo e($verpmsy); ?></td>
                                            <?php break; ?>
                                        <?php endswitch; ?>
                                    </tr>
                                <?php endfor; ?>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    ?>
                                    <td><?php echo e($H); ?></td>
                                    <td><?php echo e($puinf); ?></td>
                                    <td><?php echo e($pusup); ?></td>
                                    <td><?php echo e($Mninf); ?></td>
                                    <td><?php echo e($Mnsup); ?></td>
                                    <td><?php echo e($Mpri); ?></td>
                                    <td><?php echo e($Mpr); ?></td>
                                    <td><?php echo e($MpriII); ?></td>
                                    <td><?php echo e($MprII); ?></td>
                                    <td><?php echo e($VN); ?></td>
                                    <td><?php echo e($VUD); ?></td>
                                    <td><?php echo e($VudEtap); ?></td>
                                    <td><?php echo e($VUMAX); ?></td>
                                    <td><?php echo e($VC); ?></td>
                                    <td><?php echo e($VerifiUtEstribo); ?></td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    ?>
                                    <td class="text-lg py-2 px-4"><?php echo e($VsRef); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VsRefMax); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VerifArticulo); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($AceroEstribo); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($DiaAcero); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($areaAcer); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($aceroMxLon); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($DiaAceroMxLong); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($areaAcerl); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($nRe); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($AV); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($So); ?></td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    ?>
                                    <td class="text-lg py-2 px-4"><?php echo e($lo1); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($lo2); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($lo3); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($ZconfinaSo); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($ZconfinaSo2); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($so3); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($sII); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax2); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax2); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax3); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smaxx); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax4); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax5); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax7); ?></td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
                ...
                <div class="overflow-x-auto">
                    <table id="" class="min-w-full text-gray-800 dark:text-white">
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    <th class="text-lg py-2 px-4">Piso <?php echo e($piso_num + 1); ?></th>
                                    <?php
                                        $lo = max($lo1, $lo2, $lo3);
                                    ...
                                    ?>
                                    <td class="text-lg py-2 px-4"><?php echo e($lo); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($sO); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($multiplo_superior); ?></td>
                                    <td class="text-lg py-2 px-4">15</td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VSton); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($FyVcVs); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VrfResistencia); ?></td>
                                    <td class="text-lg py-2 px-4">1</td>
                                    <td class="text-lg py-2 px-4">5</td>
                                    <td class="text-lg py-2 px-4"><?php echo e($NEstribos); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($sO); ?></td>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    ?>
                                    <td class="text-lg py-2 px-4"><?php echo e($Tgrapas); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($tet); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($n_grapas); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($ashresul); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($bc); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($ach); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($ashmin1); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($ashmin2); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($verarti); ?></td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    ?>
                                    <td class="text-lg py-2 px-4"><?php echo e($H); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($puinf); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($pusup); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Mninf); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Mnsup); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Mpriy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Mpry); ?></td>

                                    <td class="text-lg py-2 px-4"><?php echo e($MpriIIy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($MprIIy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VNy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VUDy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VudEtap); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VUMAXy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VCy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VerifiUtEstriboy); ?></td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    ?>
                                    <td class="text-lg py-2 px-4"><?php echo e($VsRefy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VsRefMaxy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VerifArticuloy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($AceroEstriboy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($DiaAceroy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($areaAcery); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($aceroMxLony); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($DiaAceroMxLongy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($AaceromaxLong); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($nRey); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($AVy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Soy); ?></td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    ?>
                                    <td class="text-lg py-2 px-4"><?php echo e($lo1y); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($lo2y); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($lo3); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($ZconfinaSoy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($ZconfinaSo2y); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($so3); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($sII); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smaxy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax2y); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax3y); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smaxxy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax4y); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax5y); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax6); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($Smax7y); ?></td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    ?>
                                    <td class="text-lg py-2 px-4"><?php echo e($loy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($sOy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($SIy); ?></td>
                                    <td class="text-lg py-2 px-4">15</td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VStony); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($FyVcVsy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($VrfResistenciay); ?></td>
                                    <td class="text-lg py-2 px-4">1</td>
                                    <td class="text-lg py-2 px-4">5</td>
                                    <td class="text-lg py-2 px-4"><?php echo e($NEstribosy); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($sOy); ?></td>
                                    <td class="text-lg py-2 px-4">resto</td>
                                    <td class="text-lg py-2 px-4"><?php echo e($SIy); ?></td>
                                </tr>
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                            <?php for($piso_num = 0; $piso_num < count($pisos_datos_array_p); $piso_num++): ?>
                                <tr class="bg-gray-100 dark:bg-gray-600">
                                    ...
                                    ?>
                                    <td class="text-lg py-2 px-4"><?php echo e($NEstrFinalEX); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($spaciaFinalEX); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($NEstrFinalConf); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($spaciaFinalConf); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($NEstrFinalCen); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($spaciaFinalCent); ?></td>
                                    <td class="text-lg py-2 px-4"><?php echo e($EsqArFinal); ?></td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
...
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\resultadoColumna.blade.php ENDPATH**/ ?>