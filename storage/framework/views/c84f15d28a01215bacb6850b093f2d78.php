...
<div class="md:flex md:items-center mb-1">
    <div class="md:w-1/3">
        <label class="block text-xs text-gray-950 font-bold md:text-right mb-4 md:mb-0 pr-2" for="<?php echo e($id); ?>">
            <?php echo e($label); ?>
...
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\muros-contencion\components\shared\input-muros.blade.php ENDPATH**/ ?>