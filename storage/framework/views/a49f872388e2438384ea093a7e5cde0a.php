...
<body>
    ...
    <div class="container">
        <div class="header">
            <div class="topbar">
                <div class="brand">
                    <a class="py-2 text-lg font-bold text-white" href="<?php echo e(route('landing.home')); ?>">
                        <img class="logo mx-auto h-10 w-10"
                            src="<?php echo e(Vite::asset('resources/img/logo_rizabalAsociados.png')); ?>" alt="Logo">
                    </a>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/adm_predim_view.js']); ?>
</body>

</html><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\predim\predim.blade.php ENDPATH**/ ?>