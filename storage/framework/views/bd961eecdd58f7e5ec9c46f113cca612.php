                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 20px;">
                                Hola <strong><?php echo e($user->name); ?></strong>,
                            </p>

                            <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 20px;">
                                ¡Gracias por unirte a nosotros! Hemos recibido tu solicitud para el plan <strong
                                    style="color: #2563eb;"><?php echo e($plan->name); ?></strong>.
                            </p>
                                        ...
                                        <td>
                                            ...
                                            <table width="100%" cellpadding="8" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="color: #111827; font-size: 14px;"><?php echo e($user->email); ?>
                                    ...
                                    <td>
                                        ...
                                        <table width="100%" cellpadding="8" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="color: #111827; font-size: 14px;"><?php echo e($plan->name); ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <?php if($plan->type !== 'lifetime'): ?>
                                                <tr>
                                                    ...
                                                    <td style="color: #111827; font-size: 14px; font-weight: bold;">S/
                                                        <?php echo e(number_format($plan->price, 2)); ?></td>
                                                </tr>
                                            <?php endif; ?>
                                        </table>
                                    </td>
...
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\planesUser\emails\payment-request-client.blade.php ENDPATH**/ ?>