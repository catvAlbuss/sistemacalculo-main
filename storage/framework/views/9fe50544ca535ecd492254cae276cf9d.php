...
<table id="desingcorte" class="min-w-full text-gray-800 dark:text-white">
    ...
    <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'><?php echo e($c1); ?> m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>c´<sub>1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($c_1); ?> m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'>Luz libre entre columnas</td>
            <td class='py-2 px-4 text-center'>l<sub>n</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($ln); ?> m</td>
        </tr>
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($PD1); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>P<sub>L1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($PL1); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>P<sub>SX1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($PSX1); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>P<sub>SY1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($PSY1); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>Dx1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($MDx1); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>Lx1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($MLx1); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>Dy1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($MDy1); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>Ly1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($MLy1); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>SX1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($MSX1); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>SY1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($MSY1); ?> tonnef⋅m</td>
        </tr>
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($PD2); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>P<sub>L2</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($PL2); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>P<sub>SX2</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($PSX2); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>P<sub>SY2</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($PSY2); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>Dx2</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($MDx2); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>Lx2</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($MLx2); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>Dy2</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($MDy2); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>Ly2</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($MLy2); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>SX2</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($MSX2); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($qneta); ?> kgf/cm<sup>2</sup></td>
        </tr>
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($b1); ?> m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>B<sub>2</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($b2); ?> m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>L<sub>1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'><?php echo e($L2); ?> m</td>
        </tr>
    </tbody>
    ...
    <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'> <?php echo e($at); ?> m<sup>2</sup></td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'><?php echo e($Xc); ?> m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>L<sub>1</sub></td>
            <td class='py-2 px-4 text-center'></td>
            <td class='py-2 px-4 text-center'> <?php echo e($L1); ?>m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'> <?php echo e($ecce); ?> m</td>
        </tr>
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'> <?php echo e($L); ?> m</td>
        </tr>
    </tbody>
    ...
    <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'><?php echo e($O11max); ?> tonnef/m <sup>2</sup> </td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            ...
            <td class='py-2 px-4 text-center'>(R<sub>1</sub> * 1.05 )/(B<sub>1</sub> * L<sub>1</sub>) - 6 *
                (M<sub>Dy1</sub> + M<sub>Ly1</sub>)/(B<sub>1</sub><sup>2</sup> * L<sub>1</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O11min); ?> tonnef/m <sup>2</sup></td>
        </tr>
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'><?php echo e($O12max); ?> tonnef/m <sup>2</sup> </td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            ...
            <td class='py-2 px-4 text-center'>(R<sub>2</sub> * 1.05 )/(B<sub>2</sub> * L<sub>2</sub>) - 6 *
                (M<sub>Dy2</sub> + M<sub>Ly2</sub>)/(B<sub>2</sub><sup>2</sup> * L<sub>2</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O12min); ?> tonnef/m <sup>2</sup></td>
        </tr>
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'><?php echo e($C2P1); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>1</sub></td>
            <td class='py-2 px-4 text-center'>M<sub>Dx1</sub> + M<sub>Lx1</sub> - M<sub>SX1</sub></td>
            <td class='py-2 px-4 text-center'><?php echo e($C2M1); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>R<sub>1</sub></td>
            <td class='py-2 px-4 text-center'>(P<sub>1</sub> * δ - M<sub>1</sub> - M<sub>2</sub>)/L </td>
            <td class='py-2 px-4 text-center'><?php echo e($C2R1); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>P<sub>2</sub></td>
            <td class='py-2 px-4 text-center'>P<sub>DL2</sub> + P<sub>SX2</sub> </td>
            <td class='py-2 px-4 text-center'><?php echo e($C2P2); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>2</sub></td>
            <td class='py-2 px-4 text-center'>M<sub>Dx2</sub> + M<sub>Lx2</sub> - M<sub>SX2</sub></td>
            <td class='py-2 px-4 text-center'><?php echo e($C2M2); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>R<sub>2</sub></td>
            <td class='py-2 px-4 text-center'>(P<sub>1</sub> + P<sub>2</sub> - R<sub>1</sub>) </td>
            <td class='py-2 px-4 text-center'><?php echo e($C2R2); ?> tonnef</td>
        </tr>
         <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'>(R<sub>1</sub> * 1.05 )/(B<sub>1</sub> * L<sub>1</sub>) + 6 *
                (M<sub>Dy1</sub> + M<sub>Ly1</sub>)/(B<sub>1</sub><sup>2</sup> * L<sub>1</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O21max); ?> tonnef/m <sup>2</sup> </td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            ...
            <td class='py-2 px-4 text-center'>(R<sub>1</sub> * 1.05 )/(B<sub>1</sub> * L<sub>1</sub>) - 6 *
                (M<sub>Dy1</sub> + M<sub>Ly1</sub>)/(B<sub>1</sub><sup>2</sup> * L<sub>1</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O21min); ?> tonnef/m <sup>2</sup></td>
        </tr>
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'>(R<sub>2</sub> * 1.05 )/(B<sub>2</sub> * L<sub>2</sub>) + 6 *
                (M<sub>Dy2</sub> + M<sub>Ly2</sub>)/(B<sub>2</sub><sup>2</sup> * L<sub>2</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O22max); ?> tonnef/m <sup>2</sup> </td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            ...
            <td class='py-2 px-4 text-center'>(R<sub>2</sub> * 1.05 )/(B<sub>2</sub> * L<sub>2</sub>) - 6 *
                (M<sub>Dy2</sub> + M<sub>Ly2</sub>)/(B<sub>2</sub><sup>2</sup> * L<sub>2</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O22min); ?> tonnef/m <sup>2</sup></td>
        </tr>
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'>P<sub>1</sub></td>
            <td class='py-2 px-4 text-center'>P<sub>DL1</sub> - P<sub>SX1</sub> </td>
            <td class='py-2 px-4 text-center'><?php echo e($C3P1); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>1</sub></td>
            <td class='py-2 px-4 text-center'>M<sub>Dx1</sub> + M<sub>Lx1</sub> + M<sub>SX1</sub></td>
            <td class='py-2 px-4 text-center'><?php echo e($C3M1); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>R<sub>1</sub></td>
            <td class='py-2 px-4 text-center'>(P<sub>1</sub> * δ - M<sub>1</sub> - M<sub>2</sub>)/L </td>
            <td class='py-2 px-4 text-center'><?php echo e($C3R1); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>P<sub>2</sub></td>
            <td class='py-2 px-4 text-center'>P<sub>DL2</sub> - P<sub>SX2</sub> </td>
            <td class='py-2 px-4 text-center'><?php echo e($C3P2); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>2</sub></td>
            <td class='py-2 px-4 text-center'>M<sub>Dx2</sub> + M<sub>Lx2</sub> + M<sub>SX2</sub></td>
            <td class='py-2 px-4 text-center'><?php echo e($C3M2); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>R<sub>2</sub></td>
            <td class='py-2 px-4 text-center'>P<sub>1</sub> + P<sub>2</sub> - R<sub>1</sub> </td>
            <td class='py-2 px-4 text-center'><?php echo e($C3R2); ?> tonnef</td>
        </tr>
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'>(R<sub>1</sub> * 1.05 )/(B<sub>1</sub> * L<sub>1</sub>) + 6 *
                (M<sub>Dy1</sub> + M<sub>Ly1</sub>)/(B<sub>1</sub><sup>2</sup> * L<sub>1</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O31max); ?> tonnef/m <sup>2</sup> </td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>σ<sub>21min</sub></td>
            <td class='py-2 px-4 text-center'>(R<sub>1</sub> * 1.05 )/(B<sub>1</sub> * L<sub>1</sub>) - 6 *
                (M<sub>Dy1</sub> + M<sub>Ly1</sub>)/(B<sub>1</sub><sup>2</sup> * L<sub>1</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O31min); ?> tonnef/m <sup>2</sup></td>
        </tr>
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'>(R<sub>2</sub> * 1.05 )/(B<sub>2</sub> * L<sub>2</sub>) + 6 *
                (M<sub>Dy2</sub> + M<sub>Ly2</sub>)/(B<sub>2</sub><sup>2</sup> * L<sub>2</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O32max); ?> tonnef/m <sup>2</sup> </td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>σ<sub>12min</sub></td>
            <td class='py-2 px-4 text-center'>(R<sub>2</sub> * 1.05 )/(B<sub>2</sub> * L<sub>2</sub>) - 6 *
                (M<sub>Dy2</sub> + M<sub>Ly2</sub>)/(B<sub>2</sub><sup>2</sup> * L<sub>2</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O32min); ?> tonnef/m <sup>2</sup></td>
        </tr>
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'><?php echo e($C4P1); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>1</sub></td>
            <td class='py-2 px-4 text-center'>M<sub>Dx1</sub> + M<sub>Lx1</td>
            <td class='py-2 px-4 text-center'><?php echo e($C4M1); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>R<sub>1</sub></td>
            <td class='py-2 px-4 text-center'>(P<sub>1</sub> * δ - M<sub>1</sub> - M<sub>2</sub>)/L </td>
            <td class='py-2 px-4 text-center'><?php echo e($C4R1); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>P<sub>2</sub></td>
            <td class='py-2 px-4 text-center'>P<sub>DL2</sub> + P<sub>SY2</sub> </td>
            <td class='py-2 px-4 text-center'><?php echo e($C4P2); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>M<sub>2</sub></td>
            <td class='py-2 px-4 text-center'>M<sub>Dx2</sub> + M<sub>Lx2</sub></td>
            <td class='py-2 px-4 text-center'><?php echo e($C4M2); ?> tonnef⋅m</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>R<sub>2</sub></td>
            <td class='py-2 px-4 text-center'>(P<sub>1</sub> + P<sub>2</sub> - R<sub>1</sub>) </td>
            <td class='py-2 px-4 text-center'><?php echo e($C4R2); ?> tonnef</td>
        </tr>
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'><?php echo e($O41max); ?> tonnef/m <sup>2</sup> </td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>σ<sub>21min</sub></td>
            <td class='py-2 px-4 text-center'>(R<sub>1</sub> * 1.05 )/(B<sub>1</sub> * L<sub>1</sub>) - 6 *
                (M<sub>Dy1</sub> + M<sub>Ly1</sub> + M<sub>SY1</sub> )/(B<sub>1</sub><sup>2</sup> * L<sub>1</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O41min); ?> tonnef/m <sup>2</sup></td>
        </tr>
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
        ...
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'><?php echo e($O42max); ?> tonnef/m <sup>2</sup> </td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
            <td class='py-2 px-8'></td>
            <td class='py-2 px-4 text-center'>σ<sub>12min</sub></td>
            <td class='py-2 px-4 text-center'>(R<sub>2</sub> * 1.05 )/(B<sub>2</sub> * L<sub>2</sub>) - 6 *
                (M<sub>Dy2</sub> + M<sub>Ly2</sub> + M<sub>SY2</sub>)/(B<sub>2</sub><sup>2</sup> * L<sub>2</sub>)</td>
            <td class='py-2 px-4 text-center'><?php echo e($O42min); ?> tonnef/m <sup>2</sup></td>
        </tr>
    </tbody>
    ...
    <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
        <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <td class='py-2 px-4 text-center'><?php echo e($P1); ?> tonnef</td>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
             <td class='py-2 px-8'></td>
             <td class='py-2 px-4 text-center'>P<sub>1</sub></td>
...
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\hcalculo\resultadoZapataConectada.blade.php ENDPATH**/ ?>