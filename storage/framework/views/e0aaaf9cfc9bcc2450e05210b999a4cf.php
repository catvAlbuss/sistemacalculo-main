...
<?php $component->withAttributes(['title' => 'Memoria Descriptiva - Consideraciones de Diseño']); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center mt-8 pt-6 border-t">
                        <a href="<?php echo e(route('calculadora.asistente.memoria-descriptiva.generalidades')); ?>" class="px-5 py-2 bg-gray-200 rounded-lg hover:bg-gray-300 transition">← Anterior</a>
                        ...
                        <a href="<?php echo e(route('calculadora.asistente.memoria-descriptiva.predimensionamiento')); ?>" class="px-5 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition">Siguiente →</a>
                    </div>
    ...
    <?php if (! $__env->hasRenderedOnce('33ca6a43-8ecd-4c59-9bfb-a432c4c0e764')): $__env->markAsRenderedOnce('33ca6a43-8ecd-4c59-9bfb-a432c4c0e764');
...
<?php endif; ?><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\memoria_descriptiva\sections\consideraciones.blade.php ENDPATH**/ ?>