...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Analisis Por Viento')); ?>
    ...
    <script src="<?php echo e(asset('assets/js/adm_desing_cartelas_maderas.js')); ?>"></script>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\diseno_en_madera\admdesingcartelasmadera.blade.php ENDPATH**/ ?>