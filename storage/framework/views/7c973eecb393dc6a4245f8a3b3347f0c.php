...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.calc-layout','data' => ['title' => 'Irregularidades Estructurales']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Irregularidades Estructurales']); ?>
    <!DOCTYPE html>
    ...
    <head>
        ...
        <link type="image/x-icon" href="<?php echo e(url('/assets/img/logo_rizabalAsociados.png')); ?>" rel="icon">
    </head>
    ...
    <body class="hold-transition sidebar-mini layout-fixed small">
        ...
        <?php if (! $__env->hasRenderedOnce('8d1b9464-6c92-416c-8050-b3ffbffeedc6')): $__env->markAsRenderedOnce('8d1b9464-6c92-416c-8050-b3ffbffeedc6');
$__env->startPush('scripts'); ?>
        ...
        <?php echo app('Illuminate\Foundation\Vite')('resources/js/irregularidades.js'); ?>
...
</style><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\admIrregularidades.blade.php ENDPATH**/ ?>