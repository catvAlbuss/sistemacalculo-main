...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.calc-layout','data' => ['title' => 'Diseño de Zapata Conectada']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Diseño de Zapata Conectada']); ?>
  <div class="py-12">
        ...
        <div class="w-full md:w-1/3">
          <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
            ...
            <div class="overflow-auto">
              <form id="DataZapataconectada" action="<?php echo e(route('zapataconectadaCon')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <?php if (! $__env->hasRenderedOnce('bed96021-2a92-43a2-9f52-c1d7efa891ec')): $__env->markAsRenderedOnce('bed96021-2a92-43a2-9f52-c1d7efa891ec');
$__env->startPush('scripts'); ?>
      <script src="https://cdn.jsdelivr.net/npm/echarts@latest/dist/echarts.min.js"></script>
      <script type="module" src="https://cdn.jsdelivr.net/npm/chart.js"></script>
      <?php echo app('Illuminate\Foundation\Vite')('resources/js/adm_zapata_conectada.js'); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\hcalculo\admZapataConectada.blade.php ENDPATH**/ ?>