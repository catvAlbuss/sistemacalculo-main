...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
         <?php if($alert): ?>
                ...
                <div class="p-4 rounded-lg border-l-4 font-medium <?php echo e($alertClass); ?>" role="alert">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <i class="<?php echo e($alertIcon); ?> text-xl mt-1"></i>
                            <p class="text-sm leading-relaxed"><?php echo $alert['message']; ?></p>
                        </div>

                        <?php if(!empty($alert['show_button'])): ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views/dashboard.blade.php ENDPATH**/ ?>