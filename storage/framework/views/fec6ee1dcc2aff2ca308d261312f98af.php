...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['cadSystemId' => 'cad-system']));
...
foreach (array_filter((['cadSystemId' => 'cad-system']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data="cad3DViewer()" 
     x-init="init3DViewer('<?php echo e($cadSystemId); ?>')"
...
<?php $__env->stopPush(); ?><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\components\cad\3d-viewer.blade.php ENDPATH**/ ?>