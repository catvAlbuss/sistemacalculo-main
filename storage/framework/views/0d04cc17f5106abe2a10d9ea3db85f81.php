...
<div class="predim-ribbon">
    ...
    <div class="predim-topbar">
        <a href="<?php echo e(route('landing.home')); ?>">
            <img class="predim-logo" src="<?php echo e(Vite::asset('resources/img/logo_rizabalAsociados.png')); ?>" alt="Logo">
        </a>
...
</script><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views/predim/components/ribbon-topbar.blade.php ENDPATH**/ ?>