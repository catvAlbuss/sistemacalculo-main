...
if ($HVer < $Lv) { $Verificacion="<" ; } else { $Verificacion=">" ; } $VerFinal="" ; if ($HVer> $Lv) {
    ...
    if ($VuaTN < $VuTN) { $ccmcca="Cumple" ; } else { $ccmcca="Aumentar Altura" ; } $verh2=$H2 / 2; $verh2Div=$verh2 / 100; $verfCortPunzo="" ; if ($verh2Div> $Lv) {
        ...
        <table id="" class="min-w-full text-gray-800 dark:text-white">
            ...
            <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-3 px-8 text-center'><?php echo e($Lv); ?> m</td>
                </tr>
                <tr class="bg-gray-100 dark:bg-gray-600">
                    <td class="px-2">Ancho del cimiento corrido</td>
                    <td class='py-3 px-8 text-center'>H</td>
                    <td class='py-3 px-8 text-center'>H/100</td>
                    <td class='py-3 px-8 text-center'><?php echo e($HVer); ?> cm</td>
                </tr>
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-3 px-8 text-center'></td>
                    <td class='py-3 px-8 text-center'><?php echo e($VuTN); ?> </td>
                </tr>
                <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-3 px-8 text-center'></td>
                    <td class='py-3 px-8 text-center'><?php echo e($verh2); ?> cm</td>
                </tr>
                <tr class="bg-gray-100 dark:bg-gray-600">
        ...
        </table><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\resultadoCimientoCorrido.blade.php ENDPATH**/ ?>