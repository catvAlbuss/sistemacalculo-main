...
<div class="text-gray-900 flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
    <div
        class="w-full sm:max-w-md flex-grow mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
        <div>
            <!-- Session Status -->
...
</div><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\livewire\pages\auth\login.blade.php ENDPATH**/ ?>