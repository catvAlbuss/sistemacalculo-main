...
<nav class="sticky top-6 flex flex-col gap-1">
    ...
    <a href="<?php echo e(route('calculadora.asistente.memoria-descriptiva.portada')); ?>" 
       class="px-4 py-2.5 rounded-r-lg transition-all duration-200 text-base font-medium flex items-center gap-3 <?php echo e(request()->routeIs('calculadora.asistente.memoria-descriptiva.portada') ? 'bg-green-50 text-green-700 border-l-4 border-green-600' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
...
</nav><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\memoria_descriptiva\partials\sidebar-nav-md.blade.php ENDPATH**/ ?>