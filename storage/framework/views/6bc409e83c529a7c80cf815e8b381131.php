                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                                    ...
                                    <td>
                                        ...
                                        <table width="100%" cellpadding="8" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="color: #111827; font-size: 14px;"><?php echo e($paymentRequest->name); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: #111827; font-size: 14px;">
                                                    <a href="mailto:<?php echo e($paymentRequest->email); ?>"
                                                        style="color: #2563eb; text-decoration: none;">
                                                        <?php echo e($paymentRequest->email); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: #111827; font-size: 14px;">
                                                    <a href="https://wa.me/<?php echo e(str_replace([' ', '-', '+'], '', $paymentRequest->phone)); ?>"
                                                        style="color: #10b981; text-decoration: none;">
                                                        <?php echo e($paymentRequest->phone); ?>
                                    ...
                                    <td>
                                        ...
                                        <table width="100%" cellpadding="8" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: #111827; font-size: 14px;"><?php echo e($plan->duration_text); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: #111827; font-size: 14px;">
                                                    <span
                                                        ...
                                                        <?php echo e(strtoupper($plan->type)); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: #111827; font-size: 18px; font-weight: bold;">S/
                                                    <?php echo e(number_format($paymentRequest->amount, 2)); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <?php if($paymentRequest->payment_proof): ?>
                                <div
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p
                                                ...
                                                "<?php echo e($paymentRequest->message); ?>"
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p style="color: #7f1d1d; font-size: 14px; margin: 0;">
                                            ...
                                            <?php echo e($paymentRequest->created_at->format('d/m/Y H:i')); ?>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="<?php echo e(url('/admin/payment-requests')); ?>"
                    ...
                    <tr>
                        <td
                            ...
                            <p style="color: #9ca3af; font-size: 11px; margin: 0;">
                                Solicitud ID: #<?php echo e($paymentRequest->id); ?>
...
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\planesUser\emails\payment-request-admin.blade.php ENDPATH**/ ?>