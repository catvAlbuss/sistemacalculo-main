    ...
    <div class="" x-data="contactForm()">
        <div class="container mx-auto px-4 py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <?php echo e($plan->type === 'lifetime' ? 'ring-4 ring-yellow-400' : ''); ?>">

                        <!-- Badge para plan destacado -->
                        <?php if($plan->type === 'lifetime'): ?>
                        ...
                        <div class="p-8">
                            ...
                            <div class="w-16 h-16 mx-auto mb-4 bg-blue-500 rounded-full flex items-center justify-center">
                                <i
                                    class="fas <?php echo e($plan->type === 'lifetime' ? 'fa-infinity' : ($plan->type === 'trial' ? 'fa-clock' : 'fa-star')); ?> text-white text-2xl"></i>
                            </div>
                            ...
                            <div class="text-center mb-6">
                                ...
                                <?php else: ?>
                                    <div class="text-4xl font-bold text-gray-800">
                                        S/ <?php echo e(number_format($plan->price, 2)); ?>

                                    </div>
                                    <p class="text-gray-600 text-sm mt-1"><?php echo e($plan->duration_text); ?></p>
                                <?php endif; ?>
                            </div>
                            ...
                            <!-- Botón de selección -->
                            <button @click="selectPlan(<?php echo e(json_encode($plan)); ?>)"
                                class="w-full py-3 px-6 rounded-lg font-bold text-white transition-all duration-300 transform hover:scale-105
                                   <?php echo e($plan->type === 'lifetime' ? 'bg-yellow-400 hover:from-yellow-500 hover:to-orange-600' : 'bg-blue-600 hover:from-blue-700 hover:to-indigo-700'); ?>">
            ...
            <div x-show="showForm" x-transition:enter="transition ease-out duration-300"
                ...
                <form action="<?php echo e(route('contacto.store')); ?>" method="POST" enctype="multipart/form-data" class="p-8"
                    @submit="handleSubmit">
                    <?php echo csrf_field(); ?>
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <div class="bg-white p-4 rounded-lg inline-block mb-3">
                                            <img src="<?php echo e(Vite::asset('resources/img/qrcodeyapera.png')); ?>" alt="QR Yape"
                                                class="w-60 h-60">
                                        </div>
...
<?php echo $__env->make('layouts.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\landing\contact.blade.php ENDPATH**/ ?>