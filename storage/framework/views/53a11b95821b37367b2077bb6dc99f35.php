                        ...
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 25px;">
                                ¡Excelentes noticias! Hemos confirmado tu pago y tu suscripción al plan <strong
                                    style="color: #10b981;"><?php echo e($plan->name); ?></strong> ya está activa.
                            </p>
                                    ...
                                    <td>
                                        ...
                                        <table width="100%" cellpadding="12" cellspacing="0">
                                            ...
                                            <tr style="border-bottom: 1px solid #d1fae5;">
                                                ...
                                                <td style="color: #111827; font-size: 14px; text-align: right;">
                                                    <?php echo e($subscription->starts_at->format('d/m/Y')); ?></td>
                                            </tr>
                                            <tr style="border-bottom: 1px solid #d1fae5;">
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    S/ <?php echo e(number_format($subscription->amount_paid, 2)); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td
                            ...
                            <p style="color: #9ca3af; font-size: 11px; margin: 0;">
                                ID de Suscripción: #<?php echo e($subscription->id); ?>
...
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\planesUser\emails\payment-confirmed.blade.php ENDPATH**/ ?>