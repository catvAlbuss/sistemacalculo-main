    ...
    <nav class="border-gray-200">
        <div class="container mx-auto flex flex-wrap items-center justify-between">
            <a href="#" class="text-white text-lg font-bold py-2">
                ...
                <img class="mx-auto h-10 w-10 logo" src="<?php echo e(url('/assets/img/logo_rizabalAsociados.png')); ?>"
                    alt="author avatar">
            </a>
    ...
    <div class="py-2">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="w-full relative flex flex-col items-center justify-center min-h-screen py-2 rounded-lg">
                <input type="hidden" name="previewblog" id="previewblog" value="<?php echo e($blog->descripciondetall); ?>">
...
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\blogs\show.blade.php ENDPATH**/ ?>