    ...
    <table id="" class="min-w-full text-gray-800 dark:text-white">
        ...
        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center' colspan="2"> <?php echo e($desc); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Ubicación del diseño</td>
                <td class='py-2 px-4 text-center'>Ubic.</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($ubi); ?> </td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Resistencia a la Compresión de la Albañilería</td>
                <td class='py-2 px-4 text-center'>F'm</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($fm); ?> Tn/m<sup>2</sup></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($t); ?> m</td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($h); ?> m</td>
            </tr>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($pm_e); ?> </td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($pg); ?> </td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($ve); ?> </td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"> <?php echo e($me); ?></td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($vdm); ?> m</td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($nh); ?> Hiladas</td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($db); ?></td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($nc); ?> </td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($fdc); ?> Kg/cm<sup>2</sup></td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($pt1_e); ?> </td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($pt2); ?></td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($lm); ?>m</td>
            </tr>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($diameter); ?></td>
            </tr>
        </tbody>
        ...
        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($vu); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Momento flector en el muro generado por el sismo severo</td>
                <td class='py-2 px-4 text-center'>Mu</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($mu); ?></td>
            </tr>
        </tbody>
        ...
        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($pm); ?> Tn/m<sup>2</sup></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($fa); ?> Tn/m<sup>2</sup></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Área tributaria - nudo exterior</td>
                <td class='py-2 px-4 text-center'>f'm</td>
                <td class='py-2 px-4 text-center'>f'm * 0.15, 2</td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($qfm); ?> Tn/m<sup>2</sup></td>
            </tr>
        </tbody>
        ...
        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($vm); ?> Tn</td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>α</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"> <?php echo e($al); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Fuerza cortante asociada al agrietamiento diagonal</td>
                <td class='py-2 px-4 text-center'>V'm</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($vdm); ?> Tn/m<sup>2</sup></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>Vm</td>
                <td class='py-2 px-4 text-center'>0.55 * Vm</td>
                <td class='py-2 px-4 text-center' colspan="2"> <?php echo e($qvm); ?> Tn</td>
            </tr>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'>Ve</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2">Ve = <?php echo e($ve); ?> </td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Condición</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'>---</td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($cond); ?></td>
            </tr>
        </tbody>
        ...
        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'>Vu </td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($vu); ?> Tn</td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>Mu </td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($mu); ?> Tn-m</td>
            </tr>
        </tbody>
        ...
        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center' colspan="2"> <?php echo e($qqfm . ' Tn/m'); ?><sup>2</sup></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>La cuantía mínima a ser considerada es: </td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><span>ρAs/(s.t)≥0.001</td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($text); ?></td>
            </tr>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($nh); ?></td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'> </td>
                <td class='py-2 px-4 text-center'>---</td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($cantB); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Armado</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'>---</td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($arm); ?></td>
            </tr>
        </tbody>
        ...
        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($m); ?> Tn-m</td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($f); ?> Tn</td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Número de columnas de confinamiento</td>
                <td class='py-2 px-4 text-center'>Nc </td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'>F'c</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($fdc); ?> Kg/cm<sub>2</sub></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Esfuerzo de fluencia del acero</td>
                <td class='py-2 px-4 text-center'>Fy </td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($fy); ?> Kg/cm<sub>2</sub></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>Pc</td>
                <td class='py-2 px-4 text-center'>Pg / Nc</td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($pc); ?> Tn</td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>Vm</td>
                <td class='py-2 px-4 text-center'>0.5 * V'm * α * t * L + 0.23 * Pg</td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($vm); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>Pt1</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($pt1); ?> 1/4 pg muro</td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>L </td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($l); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>Pt2</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($pt2); ?> 1/4 pg muro</td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>H </td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($h); ?></td>
            </tr>
            <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                <td class='py-2 px-8'>Descripción</td>
                <td class='py-2 px-4 text-center'></td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($ts1); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($ts2); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($ts2); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($ts5); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Compresión</td>
                <td class='py-2 px-4 text-center'>C</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($ts3); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($ts6); ?></td>
            </tr>
            <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'>Fy</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($fy); ?> Kg/cm<sup>2</sup></td>
            </tr>
            <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                <td class='py-2 px-8'>Descripción</td>
                <td class='py-2 px-4 text-center'></td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'><?php echo e($tso1); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tso7); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>Asf</td>
                <td class='py-2 px-4 text-center'>Acf * 1000 / (Fy * 1 * 0.85)</td>
                <td class='py-2 px-4 text-center'><?php echo e($tso2); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tso8); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>Ast</td>
                <td class='py-2 px-4 text-center'>Asf * 1000 / (Fy * 0.85)</td>
                <td class='py-2 px-4 text-center'><?php echo e($tso3); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tso9); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>As</td>
                <td class='py-2 px-4 text-center'>Asf + Ast</td>
                <td class='py-2 px-4 text-center'><?php echo e($tso4); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tso10); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'>0.1*F'c*Ac/Fy</td>
                <td class='py-2 px-4 text-center'><?php echo e($tso5); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tso11); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Comparación</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($use1); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($use2); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Final</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'>Asf + Ast</td>
                <td class='py-2 px-4 text-center'><?php echo e($tso6); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tso12); ?></td>
            </tr>
            <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                <td class='py-2 px-8'>Descripción</td>
                <td class='py-2 px-4 text-center'></td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tsoo1); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tsoo6); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Número</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tsoo2); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tsoo7); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>As colocado</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tsoo3); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tsoo8); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Armado</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tsoo4); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tsoo9); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>Final</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tsoo5); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tsoo10); ?></td>
            </tr>
            <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($pce); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($pci); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>δ</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($dce); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($dci); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'>15 x t * 100</td>
                <td class='py-2 px-4 text-center'><?php echo e($tst1); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tst6); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'></td>
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'><?php echo e($tst3); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tst8); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'>An</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tst4); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tst9); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>Acf</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tst5); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tst10); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tstr1e); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tstr1i); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>S2</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tstr2e); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tstr2i); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>S3</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tstr3e); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tstr3i); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>S4</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tstr4e); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tstr4i); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>S</td>
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center'><?php echo e($tstr5e); ?></td>
                <td class='py-2 px-4 text-center'><?php echo e($tstr5i); ?></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
        ...
        <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4 text-center'></td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($ts); ?> Tn</td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-8'></td>
                <td class='py-2 px-4 text-center'>As</td>
                <td class='py-2 px-4 text-center'>T * 1000 / (0.9 * Fy)</td>
                <td class='py-2 px-4 text-center' colspan="2"><?php echo e($as); ?> cm<sup>2</sup></td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
...
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\resultadoMalbanieria.blade.php ENDPATH**/ ?>