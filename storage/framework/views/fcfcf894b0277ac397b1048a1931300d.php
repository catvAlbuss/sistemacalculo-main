...
if ($HVer < $Lv) { $Verificacion="<" ; } else { $Verificacion=">" ; } $VerFinal="" ; if ($HVer> $Lv) {
    ...
    if ($VuaTN < $VuTN) { $ccmcca="Cumple" ; } else { $ccmcca="Aumentar Altura" ; } $verh2=$H2 / 2; $verh2Div=$verh2 / 100; $verfCortPunzo="" ; if ($verh2Div> $Lv) {
        ...
        <table id="" class="min-w-full text-gray-800 dark:text-white">
            ...
            <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'>H+2</td>
                    <td class='py-2 px-8 text-center'><?php echo e($H + 2); ?> cm</td>
                </tr>
            </tbody>
            <thead class="bg-gray-200 dark:bg-gray-800">
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
            ...
            <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'></td>
                    <td class='py-2 px-8 text-center'><?php echo e($CM); ?> kg/m</td>
                </tr>
                <tr class="bg-gray-100 dark:bg-gray-600">
                    <td>Carga Viva</td>
                    <td class='py-2 px-8 text-center'></td>
                    <td class='py-2 px-8 text-center'></td>
                    <td class='py-2 px-8 text-center'><?php echo e($CV); ?> kg/m</td>
                </tr>
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'><?php echo e($cu); ?> kg/m</td>
                </tr>
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'><?php echo e($on); ?> Tn/m<sup>2</sup></td>
                </tr>
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'><?php echo e($Acim); ?> m<sup>2</sup></td>
                </tr>
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'>Acim</td>
                    <td class='py-2 px-8 text-center'><?php echo e($B); ?> Tn/m<sup>2</sup></td>
                </tr>
                <tr class="bg-gray-100 dark:bg-gray-600">
                    <td>Ancho del cimiento corrido</td>
                    <td class='py-2 px-8 text-center'>B</td>
                    <td class='py-2 px-8 text-center'>B*100</td>
                    <td class='py-2 px-8 text-center'><?php echo e($b); ?> cm</td>
                </tr>
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'><?php echo e($H2); ?> cm</td>
                </tr>
            </tbody>
            <thead class="bg-gray-200 dark:bg-gray-800">
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
            ...
            <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'><?php echo e($qu); ?> tn/m<sup>2</sup></td>
                </tr>
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'><?php echo e($Lv); ?> m</td>
                </tr>
                <tr class="bg-gray-100 dark:bg-gray-600">
                    <td>Ancho del cimiento corrido</td>
                    <td class='py-2 px-8 text-center'>H</td>
                    <td class='py-2 px-8 text-center'>H/100</td>
                    <td class='py-2 px-8 text-center'><?php echo e($HVer); ?> cm</td>
                </tr>
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'>
                        <table>
                            ...
                            <tr class="bg-gray-100 dark:bg-gray-600">
                                <td style="border: none;"><?php echo e($HVer); ?></td>
                                <td style="border: none;"><?php echo e($Verificacion); ?></td>
                                <td style="border: none;"><?php echo e($Lv); ?></td>
                            </tr>
                        </table>
                    </td>
                    <td class='py-2 px-8 text-center' rowspan="2"><?php echo e($VerFinal); ?></td>
                </tr>
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'></td>
                    <td class='py-2 px-8 text-center'><?php echo e($VuaTN); ?> </td>
                </tr>
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'></td>
                    <td class='py-2 px-8 text-center'><?php echo e($VuTN); ?> </td>
                </tr>
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'>
                        ...
                        <table>
                            ...
                            <tr class="bg-gray-100 dark:bg-gray-600">
                                <td style="border: none;"><?php echo e($VuaTN); ?></td>
                                <td style="border: none;">&lt;</td>
                                <td style="border: none;"><?php echo e($VuTN); ?></td>
                            </tr>
                        </table>
                    </td>
                    <td class='py-2 px-8 text-center'><?php echo e($ccmcca); ?></td>
                </tr>
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'>H/2</td>
                    <td class='py-2 px-8 text-center'></td>
                    <td class='py-2 px-8 text-center'><?php echo e($verh2); ?> cm</td>
                </tr>
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'>
                        ...
                        <table>
                            ...
                            <tr class="bg-gray-100 dark:bg-gray-600">
                                <td style="border: none;"><?php echo e($verh2Div); ?></td>
                                <td style="border: none;">&lt;</td>
                                <td style="border: none;"><?php echo e($Lv); ?></td>
                            </tr>
                        </table>
                    </td>
                    <td class='py-2 px-8 text-center'> <?php echo e($verfCortPunzo); ?></td>
                </tr>
                <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
                ...
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    <td class='py-2 px-8 text-center'>H</td>
                    <td class='py-2 px-8 text-center'>H</td>
                    <td class='py-2 px-8 text-center'><?php echo e($H2 + 5); ?> cm</td>
                </tr>
                <tr class="bg-gray-100 dark:bg-gray-600">
                    <td></td>
                    <td class='py-2 px-8 text-center'></td>
        ...
        </table><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\hcalculo\resultadoCimientoCorrido.blade.php ENDPATH**/ ?>