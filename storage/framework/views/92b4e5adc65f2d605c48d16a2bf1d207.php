...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/predim.css']); ?>
</head>
...
<div class="predim-container">
    ...
    <?php echo $__env->make('predim.components.ribbon-topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    
    <div class="predim-workspace">
        <div class="predim-canvas-area" style="position:relative;">
            <label data-id="<?php echo e(url('/assets/pdf/Escalado.pdf')); ?>" type="hidden"></label>
...
<?php echo app('Illuminate\Foundation\Vite')(['resources/js/predim/ribbon-adapter.js']); ?>
<?php echo app('Illuminate\Foundation\Vite')(['resources/js/predim/index.js']); ?>

</body>
</html><?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\predim\predim-new.blade.php ENDPATH**/ ?>