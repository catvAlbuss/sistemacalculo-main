...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.calc-layout','data' => ['title' => 'Diseño de Losas Aligeradas']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Diseño de Losas Aligeradas']); ?>
        ...
        <div class="w-full md:w-1/3">
          <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
            ...
            <div class="overflow-auto">
              <form id="FlexionViga" method="POST" action="<?php echo e(route('desingLosa')); ?>">
                <?php echo csrf_field(); ?>
  ...
  <?php if (! $__env->hasRenderedOnce('e47e2dfd-8b64-413a-8554-9fd10543c13d')): $__env->markAsRenderedOnce('e47e2dfd-8b64-413a-8554-9fd10543c13d');
$__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/adm_losas_aligeradas.js'); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\hcalculo\admlosasaligeradas.blade.php ENDPATH**/ ?>