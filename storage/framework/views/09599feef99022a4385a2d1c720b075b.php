...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.calc-layout','data' => ['title' => 'Diseño de placas en L']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Diseño de placas en L']); ?>
    <?php if (! $__env->hasRenderedOnce('1f11d331-5757-404a-b75a-0d7d51cfb57a')): $__env->markAsRenderedOnce('1f11d331-5757-404a-b75a-0d7d51cfb57a');
$__env->startPush("styles"); ?>
                                        ...
                                        <div class="card-body p-0 m-0 hidden" class="collapsible-content"
                                            ...
                                            <div class="card m-0">
                                                <div
                                                    ...
                                                    dirección "X" <button
                                                        ...
                                                        data-target="contentDFx">ver / ocultar</button></div>
                                            ...
                                            <div class="card m-0">
                                                <div
                                                    ...
                                                    dirección "Y" <button
                                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 mr-5"
                                                        data-target="contentDFy">ver / ocultar</button></div>
                                        ...
                                        <div class="card-body p-0 m-0 hidden" class="collapsible-content"
                                            ...
                                            <div class="card m-0">
                                                <div
                                                    ...
                                                    dirección "X" <button
                                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 mr-5"
                                                        data-target="contentDCx">ver / ocultar</button></div>
                                            ...
                                            <div class="card m-0">
                                                <div
                                                    ...
                                                    dirección "Y" <button
                                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 mr-5"
                                                        data-target="contentDCy">ver / ocultar</button></div>
    ...
    <?php if (! $__env->hasRenderedOnce('bd73f6a0-bee4-4494-9303-18e98a5e5c9d')): $__env->markAsRenderedOnce('bd73f6a0-bee4-4494-9303-18e98a5e5c9d');
$__env->startPush("scripts"); ?>
        <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/handsontable/dist/handsontable.full.min.js"></script>
        <?php echo app('Illuminate\Foundation\Vite')("resources/js/adm_desing_placasL.js"); ?>
    <?php $__env->stopPush(); endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\rizabalAsociadosActualizadoServer\resources\views\hcalculo\hcalculo\admdesingPlacasL.blade.php ENDPATH**/ ?>